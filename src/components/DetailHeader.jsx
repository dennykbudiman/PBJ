...
export default function DetailHeader({ backTo, backLabel, title, subtitle, badge, children }) {
  ...
  return (
    <header style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '20px 32px', borderBottom: `1px solid ${colors.border}`, background: colors.white, flexWrap: 'wrap', rowGap: 12 }}>
      <button
        type="button"
